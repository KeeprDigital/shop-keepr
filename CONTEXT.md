...
**Stock Band** — a range of copies of a SKU the store already holds, to which a Buy Pricing Rule attaches a multiplier: the more of a card the store has, the less it pays for another. Keyed on stock on hand before the Buy, never on what is held in Baskets. Buy side only ([#48](https://github.com/KeeprDigital/shop-keepr/issues/48)).

**Quantity Band** — a range of copies of a SKU on one line of a Buy, to which a Buy Pricing Rule attaches a multiplier: seven of one card attract a lower rate than one, whatever the store holds. The whole line takes one price. Buy side only ([#48](https://github.com/KeeprDigital/shop-keepr/issues/48)).

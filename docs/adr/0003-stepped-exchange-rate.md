...
Note that "a live rate would force an expensive sweep" is _not_ a reason. A sweep is bounded by the store's own SKU count, not the Catalogue's, and is cheap. That argument was raised while deciding this and does not hold.

...
The surprise this records is that the line is *not* "whatever shop-keepr needs, the Catalogue supplies". Both repos are ours and the Catalogue changes on our word, so the cheap move is to push every requirement across the boundary. This ADR exists to say that the boundary survives common ownership.
